...
@Component({
  selector: "app-owners-employee-dismiss-modal",
  templateUrl: "./owners-employee-dismiss-modal.component.html",
  styleUrls: ["./owners-employee-dismiss-modal.component.scss"],
})
export class OwnersEmployeeDismissModalComponent implements OnInit {
  closeResult = "";
